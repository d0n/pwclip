...
version = '1.3.5'
install_requires = ['xsel', 'xvkbd', 'gpgsm', 'gnupg2', 'openssl', 'python3-tk', 'python3-gi', 'python3-wget', 'python3-gnupg', 'python3-argparse', 'python3-paramiko', 'python3-argcomplete', 'python-yubico', 'libreadline-dev']
